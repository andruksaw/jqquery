...
//         if (e.originalEvent.deltaY > 0) {/* Прокрута вниз */

//             /* scrollPosition = (scrollCounter * scrollSize) * -1 */

//             if (scrollCounter >= (maxSrollSize / scrollSize) - 2 /* нахожу конец сайта и приравниваю его к коннцу боди */) {
//                 scrollCounter = (maxSrollSize / scrollSize) - 1 /* ставлю экран на верх */

//             } else {
//                 scrollCounter++
//             }

//         } else if (e.originalEvent.deltaY < 0) {/* Прокрута вверх */
//             if (scrollCounter <= 0) {
//                 scrollCounter = 0
//             } else {
...
$('a[data-target]').click(function (e) {
    ...
    $(`div[data-target]`).not(`div[data-target=${attr}]`).slideUp(200)
